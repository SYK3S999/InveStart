      ...
      <main className="flex-1 py-12 md:py-24 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-bold text-primary-600 dark:text-primary-300 mb-4">مهمتنا</h2>
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-primary-600 dark:text-primary-300 mb-4">رؤيتنا</h2>
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-primary-600 dark:text-primary-300 mb-6">فريقنا</h2>
            ...
            <Button className="bg-primary-500 dark:bg-primary-600 text-white dark:text-white rounded-full px-6 py-3 hover:bg-primary-600 dark:hover:bg-primary-700 shadow-md transition-all duration-300">
              تعرف على فريقنا
            </Button>
          </motion.div>
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-primary-600 dark:text-primary-300 mb-6 text-center">قيمنا</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="text-center">
                  <h3 className="text-xl font-bold text-primary-500 dark:text-primary-400 mb-2">{value.title}</h3>
