...
interface AnimatedElementProps extends React.ComponentProps<typeof motion.div> {
...
export function AnimatedElement({
  ...
  if (animation === "none" || settings.animationLevel === "none") {
    // Filter out framer-motion specific props when rendering a plain div
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    const { animate, initial, exit, variants, whileHover, whileTap, whileFocus, whileDrag, layout, layoutId, transition, style, onDrag, onDragEnd, ...divProps } = props;
    return (
      <div className={cn(className)} {...(divProps as React.HTMLAttributes<HTMLDivElement>)}>
        {children}
      </div>
    )
  }
