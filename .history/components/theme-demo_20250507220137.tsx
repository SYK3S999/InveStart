      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="p-6">
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <AnimatedElement animation="fade-in" className="p-3 bg-primary/10 rounded-md">
                ظهور تدريجي
              </AnimatedElement>
              <AnimatedElement animation="slide-up" delay={200} className="p-3 bg-secondary/10 rounded-md">
                انزلاق للأعلى
              </AnimatedElement>
