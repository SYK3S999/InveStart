                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="text-2xl font-bold">
                          {formatCurrency(analyticsData?.overview.totalInvestments ?? 0)}
                        </div>
                          ...
                          <div className="space-y-6">
                            <div>
                              ...
                              <p className="text-2xl font-bold">
                                {formatCurrency(analyticsData?.overview?.averageInvestment ?? 0)}
                              </p>
                            </div>
                            ...
                            <div>
                              ...
                              <div className="flex items-center">
                                <div className="w-full bg-gray-200 rounded-full h-2.5 mr-2">
                                  <div
                                    className="bg-primary-500 h-2.5 rounded-full"
                                    style={{ width: `${analyticsData?.overview?.conversionRate ?? 0}%` }}
                                  ></div>
                                </div>
                                <span>{analyticsData?.overview?.conversionRate ?? 0}%</span>
                              </div>
                            </div>
