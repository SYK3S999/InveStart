...
import { User, Building, FileText, Save, Upload, Briefcase } from "lucide-react"
...
export default function SponsorSettingsPage() {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    phone: "0555123456",
    companyName: "شركة الاستثمار العربية",
    bio: "مستثمر متخصص في دعم المشاريع الناشئة في مجال التكنولوجيا والخدمات.",
    ...
    investmentPreferences: {
      sectors: "التكنولوجيا، الخدمات، الزراعة",
      minAmount: "100000",
      maxAmount: "1000000",
      stage: "مرحلة مبكرة، مرحلة النمو",
    },
  })
  ...
  const handleChange = (
    ...
    if (name.includes(".")) {
      const [parent, child] = name.split(".") as [
        keyof Pick<FormData, "socialMedia" | "investmentPreferences">,
        string
      ]
      setFormData({
        ...formData,
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="flex flex-col md:flex-row gap-6">
                    <div className="md:w-1/3 flex flex-col items-center">
                      ...
                      <h2 className="text-xl font-bold text-primary-500">{formData.name}</h2>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-bold text-primary-600 flex items-center">
                      <Building className="mr-2 h-5 w-5" /> معلومات الشركة
                    </h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-bold text-primary-600 flex items-center">
                      <Briefcase className="mr-2 h-5 w-5" /> تفضيلات الاستثمار
                    </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          id="sectors"
                          name="investmentPreferences.sectors"
                          value={formData.investmentPreferences.sectors}
                          onChange={handleChange}
                          className="w-full"
                        />
                      </div>
                      <div>
                        <label htmlFor="stage" className="block text-sm font-medium text-gray-700 mb-1">
                          مراحل الاستثمار المفضلة
                        </label>
                        <Input
                          id="stage"
                          name="investmentPreferences.stage"
                          value={formData.investmentPreferences.stage}
                          onChange={handleChange}
                          className="w-full"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          id="minAmount"
                          name="investmentPreferences.minAmount"
                      ...
                      <div>
                        ...
                        <Input
                          id="maxAmount"
                          name="investmentPreferences.maxAmount"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-primary-50 rounded-lg p-4 border border-primary-100">
                      <p className="text-sm text-gray-600 mb-3">
                        قم بتحميل المستندات المطلوبة للتحقق من هويتك وشركتك. يجب أن تكون جميع المستندات بصيغة PDF أو
                        JPG.
                      </p>
