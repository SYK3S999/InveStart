...
export default function BlockchainExplorerPage() {
  ...
  const [activeTab, setActiveTab] = useState<"blocks" | "transactions">("blocks") // blocks, transactions
  ...
  useEffect(() => {
    ...
    // Map returned transactions to match local Transaction type
    const txs = getTransactions().map((tx: any) => ({
      id: tx.id,
      from: tx.from,
      to: tx.to,
      amount: tx.amount,
    ...
    const allTransactions: Transaction[] = [...mockBlocks.flatMap((block) => block.transactions), ...txs]
